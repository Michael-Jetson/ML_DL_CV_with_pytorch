...
这里可以使用独热向量的编码方式（如下图所示），但是这种方式认为所有的向量是相互独立且没有关系的，没有任何语义的信息，如果在NLP中使用这种方法编码语言，会导致向量过于稀疏和计算负责等问题，所以会使用一种**词嵌入（Word Embedding）**的方法，使得输入向量具有语义信息，并且是稠密的

![lhy_attention_2](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_2.png)
...
![lhy_attention_3](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_3.png)

当然，一些图的节点也可以作为向量进行处理

![lhy_attention_4](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_4.png)

![lhy_attention_5](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_5.png)

## 输出的表示

输入就是一组向量，那么输出是什么形式呢？可以是对每个输入进行预测（输入输出的数量一样），比如说对句子的每个单词进行类别判断，也可以对整个序列进行预测，比如说对句子的情感分析，还有一种就是由模型决定输出序列的长度

![lhy_attention_6](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_6.png)

![lhy_attention_8](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_8.png)
...
![lhy_attention_9](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_9.png)
...
![EECS498_L13_11](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/EECS498_L13_11.png)
...
![lhy_attention_10](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_10.png)
...
![lhy_attention_11](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_11.png)
...
![lhy_attention_12](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_12.png)
...
![lhy_attention_13](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_13.png)

我们可以使用点积操作（Dot-product）来作为判断关联程度的模块（当然还有其他模块，但是点积法最广泛，因为有计算效率高和易于优化等优点），输入两个向量然后进行相关的点积操作，就可以计算其关联程度，此外还有加性方法（Additive）

![lhy_attention_14](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_14.png)
...
![lhy_attention_15](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_15.png)

然后对整个$\alpha$作Soft-max操作（ReLU也可以），然后得到一个归一化的关联程度，然后我们就可以根据这个去抽取重要的信息（我们根据这个知道了哪些向量跟此向量的关联性最大）

![lhy_attention_16](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_16.png)

然后我们再使用一个值矩阵计算出值（Value）向量$v$，然后将其乘以注意力分数$\alpha$，然后进行加权组合，就可以得到结果向量$b$，然后就可以看到，哪个向量更重要（或者关联性很强），那么就会抽出更多信息，那结果向量$b$就会更接近哪个向量

![lhy_attention_17](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_17.png)

当然，对于一个序列来说，计算是并行的，会同时计算出一系列的向量$b$

![lhy_attention_18](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_18.png)

同时，对于一个Self-Attention层来说，查询向量、键向量和值向量的权重矩阵是共享的。所以我们也可以这样理解，将一系列向量组合为一个矩阵，比如说查询矩阵$V$

![lhy_attention_20](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_20.png)

当然，注意力分数也可以这样进行计算，甚至我们可以进一步集成到两个矩阵中，也就是我们的注意力矩阵$A$就等于$K^TQ$，如下图所示

![lhy_attention_22](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_22.png)

然后输出向量也可以使用矩阵乘法计算

![lhy_attention_23](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_23.png)

我们可以进一步集成，将输入序列记为$I$，然后直接使用不同的可学习的权重矩阵（也就是$W^q$、$W^k$、$W^v$）计算输出

![lhy_attention_24](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_24.png)
...
![lhy_attention_25](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_25.png)
...
![lhy_attention_28](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_28.png)
...
![lhy_attention_29](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_29.png)

# 注意力机制下的语音识别

我们之前是将每10ms的声音信号片段转化为一个向量，那么1秒的信号就转化为一百个向量的集合，可以看到，随便一句话所代表的序列长度是非常长的，因为注意力矩阵的大小与序列长度有关，这样注意力矩阵就会非常庞大，会占用庞大的空间

![lhy_attention_31](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_31.png)
...
![EECS498_L13_15](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/EECS498_L13_15.png)
...
![lhy_attention_37](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_37.png)
...
![lhy_attention_32](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_32.png)

但是，这样就与CNN有了很大不同，因为CNN是逐步看到全局，而注意力机制则是直接计算与全局的关联

![lhy_attention_34](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_34.png)

或者可以将CNN看做一种带有感受野的注意力，是一种简化版或者受限制版，注意力机制是一种带有可学习感受野的CNN，是一种复杂化的CNN

![lhy_attention_35](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_35.png)
...
![lhy_attention_36](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_36.png)
...
![EECS498_L13_36](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/EECS498_L13_36.png)
...
![EECS498_L13_40](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/EECS498_L13_40.png)
...
![lhy_attention_39](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_39.png)
...
![lhy_attention_41](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/lhy_attention_41.png)
...
![EECS498_L13_92](https://raw.githubusercontent.com/Michael-Jetson/Images/main/UpGit_Auto_UpLoad/EECS498_L13_92.png)
